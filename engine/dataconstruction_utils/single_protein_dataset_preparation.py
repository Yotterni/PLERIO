from negatives_generation import NegativesCreator
from peak_processing import PeakProcessor
from pickling_batches import DatasetPickler
from sequence_extraction import SequenceExtractor
from train_val_test_splitting import MultipleDomainSplitter
...
if __name__ == '__main__':
    ...
    # datacreator('../encode_database/single_prot_dbs/K562', 0.9)
    datacreator('../encode_database/single_prot_dbs/HepG2', 0.9)
