...
class PeakProcessor:
    """
    A class for to peaks processing. It can enlarge or shorten them
    to the given length (`window_size`) and augment them using
    the left-right shift.
    """
    def __init__(self, window_size: int = 200,
                 augmentation_strides: tuple[int] = (-5, 0, 5)) -> None:
    ...
    def enlarge_many_peak_dataframes(self, dataframes: dict[str, pd.DataFrame]
                                    ) -> dict[str, pd.DataFrame]:
        """
